...
fn build_tree() -> Generator {
    ...
    // Big white-trimmed barn doors on the front gable, with board battens.
    ...
    prims.push(prim(
        ...
        [0.0, foot_h + 4.8, front + 0.05],
        id_quat(),
    ));

    // Hayloft door and hoist beam up in the gable.
    prims.push(prim(
        solid(cuboid_tapered(
            [2.0, 2.0, 0.2],
            0.0,
