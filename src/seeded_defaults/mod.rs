...
pub use avatar::{
    ...
    RoadsterTop, RoadsterWheels, RunaboutVariant, ScowLoad, SkiffBlueprint, SkiffType, SloopHull,
    SloopRig, StylizationTier, TugVariant, VehicleBlueprint, VehicleStance, WagonBody, WearBand,
    WearTier,
};
