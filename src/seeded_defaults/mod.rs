...
pub use avatar::{
    ...
    BodyArchetype, ChassisFamily, FinishRegister, HumanoidBlueprint, MaterialKit, OrnatenessBand,
    OrnatenessTier, OutfitPart, ParticleAura, StylizationTier, WearBand, WearTier,
};
