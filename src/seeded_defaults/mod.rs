...
pub use avatar::{
    ...
    AvatarPalette, AvatarPins, AvatarVoice, BoatBlueprint, BoatType, BodyArchetype, BuggyVariant,
    ChassisFamily, CraftType, FinishRegister, MaterialKit, NOMINAL_BODY_LEN, NOMINAL_HULL_LEN,
    OrnatenessBand, OrnatenessTier, OutfitPart, ParticleAura, RoadsterBody, RoadsterTop,
    RoadsterWheels, RunaboutVariant, ScowLoad, SkiffBlueprint, SkiffType, SloopHull, SloopRig,
    StylizationTier, TugVariant, VehicleBlueprint, VehicleStance, WagonBody, WearBand, WearTier,
};
