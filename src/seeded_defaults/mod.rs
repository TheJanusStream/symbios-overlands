...
pub use avatar::{
    ...
    CraftType, FinishRegister, MaterialKit, NOMINAL_HULL_LEN, OrnatenessBand, OrnatenessTier,
    OutfitPart, ParticleAura, SkiffBlueprint, SkiffType, StylizationTier, VehicleBlueprint,
